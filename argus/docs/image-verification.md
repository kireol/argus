...
Use this for status icons / indicators captured as crops on black (or any dark)
...
icon as unexpectedly present. Real icons still score close to 1.0; empty
...
```bash
argus run --save-comparisons --feature Notifications
```
