...
def test_html_report_lists_tests_and_embeds_images(tmp_path: Path) -> None:
    ...
    assert "RP-PASS" in html
    assert "RP-FAIL" in html
    assert "RP-SKIP" in html
    assert "Settings" in html
    assert "Notifications" in html
    assert "Image &#x27;icn.png&#x27; not found" in html or "Image 'icn.png' not found" in html
    assert "RP-FAIL/actual.png" in html
    assert "RP-FAIL/expected.png" in html
    assert "RP-FAIL/diff.png" in html
    assert "RP-FAIL/screenshot.png" in html
