...
class ActionRegistry:
    """Maps action names to instances; extensible via ``argus.actions`` entry points."""
    ...
    def _load_entry_points(self) -> None:
        ...
        from argus.actions.builtin import register as register_builtin

        register_builtin(self)
        for entry_point in metadata.entry_points(group="argus.actions"):
