"""Environment validation for ``utf validate`` and ``utf --dry-run``.
...
def _probe_reporting() -> CheckState:
    try:
        from utf.reporting import (  # noqa: F401
            write_html_report,
            write_json_report,
            write_junit_report,
        )
...
def print_report(report: ValidationReport, console: Console) -> None:
    ...
    if report.ready:
        ...
        console.print("Fix the ✗ items above and run 'utf validate' again.\n")
