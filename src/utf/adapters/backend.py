...
from utf.config.models import BackendConfig
from utf.exceptions import BackendError
from utf.logging import get_logger
from utf.models.common import HealthCheckResult
...
class BackendAdapter:
    ...
    def __init__(self, config: BackendConfig) -> None:
        ...
        self._config = config
        self._log = get_logger("utf.backend")
