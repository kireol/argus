...
(``type: android``). Plugins can add adapters via the ``utf.devices``
...
class DeviceRegistry:
    ...
    def _load_entry_points(self) -> None:
        ...
        for entry_point in metadata.entry_points(group="utf.devices"):
...
def register_builtin_devices(registry: DeviceRegistry) -> None:
    ...
    from utf.adapters.android import AndroidAdapter
    from utf.adapters.fake import FakeDevice
    from utf.adapters.yocto import YoctoAdapter
