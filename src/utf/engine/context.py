...
from utf.exceptions import ConfigurationError, TestExecutionError
from utf.instrumentation.client import InstrumentationClient
from utf.logging import ContextLogger, get_logger
from utf.models.common import ScreenInfo
...
if TYPE_CHECKING:
    ...
    from utf.ocr.base import OCRProvider
    from utf.verifiers.assets import AssetStore
    from utf.verifiers.base import Verifier
...
class TestContext:
    ...
    logger: ContextLogger = field(default_factory=lambda: get_logger("utf.test"))
