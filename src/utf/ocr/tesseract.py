"""Tesseract OCR provider (requires the optional ``utf[ocr]`` extra)."""
...
from utf.ocr.base import OCRProvider, OCRResult, OCRWord
...
class TesseractProvider(OCRProvider):
    ...
    def is_available(self) -> tuple[bool, str]:
        try:
            ...
            return False, 'pytesseract not installed. Install with: pip install "utf[ocr]"'
