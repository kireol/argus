...
### Fixed
- **Masked icon `image_not_present` on empty chrome.** With
  ...
  hidden icon was reported "unexpectedly present" next to unrelated text.
  The masked method now only locates the peak; the reported
